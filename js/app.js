...
$(function () {
  $(".filter__subtitle").on("click", function (e) {
    e.preventDefault();
    $(this).toggleClass("active").siblings(".filter__list").slideToggle();
  });
});
...
$(function () {
  $(".h-dropdown__toggle").on("click", function (e) {
    e.preventDefault();
    e.stopPropagation();
    $(this).siblings(".h-dropdown__menu").fadeToggle();
    $(".h-dropdown__menu").not($(this).siblings(".h-dropdown__menu")).fadeOut();
  });
